                    ...
                    <form class="form-horizontal form-label-left" method="POST" action=".../operaciones/registrar_estudiante.php">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="programa_estudios" maxlength="8" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">numero de modulo :
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="numeric" name="numero_modulo" maxlength="8" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
